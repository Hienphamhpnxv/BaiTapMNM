...
if (isset($_POST['login'])) {
    ...
    if (empty($username)) {
        ...
        $errors['username'] = 'username is limited to 255 characters in length';
    }
    ...
    $getUserByUser = "select * from users where username = '$username'  ";
    $user = exeQuery($getUserByUser, false);
            ...
            <div class="md:flex w-full">
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                  ...
                  <div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" name="username" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Username">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button name="login" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Đăng nhập</button>
                            </div>
                        </div>
                    </div>
                  </form>
